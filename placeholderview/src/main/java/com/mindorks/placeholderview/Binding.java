...
public class Binding {
    ...
    private static <T, C> C getBinderInstance(T target, String suffix) {
        ...
        System.out.println("EDWARD: target: " +target);
        System.out.println("EDWARD1: targetClass: " +targetClass);
        System.out.println("EDWARD2: className: " +className);
        System.out.println("EDWARD3: suffix: " +suffix);
        try {
            Class<?> bindingClass = targetClass
                    .getClassLoader()
                    .loadClass(className + suffix);
            System.out.println("EDWARD4: bindingClass: " +bindingClass);
            Constructor<?> classConstructor = bindingClass.getConstructor(targetClass);
            System.out.println("EDWARD5: classConstructor: " +classConstructor);
            try {
